...
_TUNABLE_NAMES = frozenset({
    ...
    "PHASE3_VAL_DRAWDOWN_RATIO_GATE",
    "PHASE3_VAL_RETURN_FLOOR_PCT",
    "PHASE3_VAL_PROFIT_FACTOR_FLOOR",
    "PHASE3_MIN_PROFITABLE_SYMBOLS",
    "PHASE3_MIN_SYMBOL_COVERAGE",
    "PHASE3_SYMBOL_CONSISTENCY_WEIGHT",
    "PHASE3_JACCARD_SIMILARITY_GATE",
    "PHASE3_VAL_TRAIN_GAP_MAX_PCT",
    "PHASE3_TRAIN_VAL_GAP_MAX_PCT",
    "PHASE3_GAP_PENALTY_WEIGHT",
    "PHASE3_VAL_GATE_PENALTY",
    "PHASE3_MIN_INCREMENTAL_TRADES",
