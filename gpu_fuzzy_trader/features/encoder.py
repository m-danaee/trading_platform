...
Maps gene integer values to fuzzy value names, formats condition strings,
...
# Maps mode → dont_care sentinel (= num_classes)
...
# ---------------------------------------------------------------------------
# Encoder class (wraps module-level functions for OOP usage)
# ---------------------------------------------------------------------------
