...
|---|---|---|
| [phase0_shared.md](phase0_shared.md) | Phase 0 — Shared | Data loading, train/val split, backtest engine, shared config |
...
| [phase2_rule_pool.md](phase2_rule_pool.md) | Phase 2 | NSGA-III evolution, joint train/val fitness |
| [phase3_rule_set.md](phase3_rule_set.md) | Phase 3 | Greedy + NSGA-II, train-target objectives, orthogonality penalties |
...
data/train.csv
    ...
    │       Train/val split via holdout_70_30 per symbol.
...
|---|---|---|
| **Stronger generalization (short OOS)** | — | Phase 0, 2, 3 |
| — | — | Phase 0 |
...
| Fees / label horizon | `FEE_PCT`, `TAIL_DROP_ROWS`, `MAX_HOLD_CANDLES` | Phase 0 |
