...
def test_phase5_rule_feature_metadata_comes_from_frozen_rules() -> None:
    train_df = _make_df(n_rows=20)
    strategy = {
        "rules_set": [{
            "conditions": [
                "[feat_1] IS High",
    ...
    assert OOS_Evaluator._rule_feature_specs(train_df, strategy) == [
